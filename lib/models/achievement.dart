...
var achievementData = [
  ...
  Achievement(
      ...
      imageUrl: "assets/img/pencapaian/Master.svg",
      currentValue: 2805,
      maxValue: 3000),
  Achievement(
      title: "Ilmuwan",
      desc: "Dapatkan 6000 poin!",
      imageUrl: "assets/img/pencapaian/Ilmuwan.svg",
      currentValue: 2805,
      maxValue: 6000),
  Achievement(
      title: "Membara",
  ...
  Achievement(
      ...
      imageUrl: "assets/img/pencapaian/Penguasa Kegelapan.svg",
      currentValue: 4,
      maxValue: 5),
  Achievement(
      title: "Juara",
      desc: "Maju ke liga selanjutnya dengan peringkat 3 besar",
      imageUrl: "assets/img/pencapaian/Juara.svg",
      currentValue: 4,
      maxValue: 5),
  Achievement(
      title: "Pemenang",
